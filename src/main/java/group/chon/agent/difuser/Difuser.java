package group.chon.agent.difuser;
...
public class Difuser extends AgArch {
    ...
    public static Difuser getArgoArch(AgArch currentArch) {
        if (currentArch == null) {
            return null;
        }
        if (currentArch instanceof Difuser) {
            return (Difuser) currentArch;
        }
